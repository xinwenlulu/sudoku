...
/* A GLOBAL VARIABLE THAT COUNTS THE NUMBER OF RECURSIONS EXCUTED TO SOLVE THE SUDOKU AS AN INDEX FOR DIFFICULTY */
static int recursion;

/* FUNCTION TO FETCH THE NUMBER OF RECURSIONS EXCUTED */
int print_recursion();
